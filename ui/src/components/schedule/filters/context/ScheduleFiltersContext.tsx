...
export const ScheduleFiltersProvider: React.FC<ScheduleFiltersProviderProps> = ({
	...
	const updateTeacherFilter = useCallback(
		(inList: boolean, items: number[]) => {
			setFilters(prev => {
	...
	// Update class filter
	const updateClassFilter = useCallback(
		(inList: boolean, items: number[]) => {
			setFilters(prev => {
	...
	const getTeacherFilterOptions = useCallback(
		(teachers: Teacher[]) => {
	...
	const getClassFilterOptions = useCallback(
		(classes: Class[]) => {
			return filterService.getFilterOptions(
				filters.classes,
				classes,
