...
import { format, startOfWeek, endOfWeek, addDays, addWeeks, isSameWeek, isToday, isTomorrow, isYesterday } from 'date-fns';
 ...
 */
export const formatDateForDisplay = (date: Date, viewType: 'day' | 'week', locale: string = 'ru'): string => {
 ...
 * Навигация по датам
 */
export const navigateDate = (currentDate: Date, direction: 'prev' | 'next', viewType: 'day' | 'week'): Date => {
  if (viewType === 'day') {
